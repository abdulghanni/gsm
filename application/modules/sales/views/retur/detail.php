				...
				<div class="row">
                    ...
                    <div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="po" value="<?=$o->so?>" class="form-control" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label" for="inputPassword3">
							...
							<div class="col-sm-8">
								<input type="text" name="po" value="<?=date('Ymd', strtotime($o->created_on)).sprintf('%04d',$o->pengeluaran_id)?>" class="form-control" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label" for="inputEmail3">
							...
							<div class="col-sm-8">
                                  <input type="text" class="form-control" name="tanggal_pengiriman" value="<?=dateIndo($o->tanggal_pengeluaran)?>" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label" for="inputPassword3">
