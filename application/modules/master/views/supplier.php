                    ...
                    <div class="row form-row">
                        <div class="col-md-6">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Nama Supplier</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select name="tipe" class="select2" style="width:100%">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">UP</label>
                                    <div class="col-md-8">
                                        <input name="up" placeholder="" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
