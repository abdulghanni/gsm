...
class barang_inv_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select(
			$this->table.'.*,
			'.$this->table_join1.'.title as jenis_inventaris
			');
		$this->db->from($this->table);
		$this->db->join($this->table_join1, $this->table_join1.'.id = '.$this->table.'.jenis_inventaris_id', 'left');
