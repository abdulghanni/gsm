...
<section id="page-title">
	<div class="row">
		...
		<ol class="breadcrumb">
			...
			<li>
				<span><a href="<?=base_url('stok/pemindahan/input')?>">input</a></span>
			</li>
		</ol>
	</div>
</section>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="select2" name="gudang_asal" style="width:100%">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="select2" name="gudang_tujuan" style="width:100%">
								<option value="0">-- Pilih Gudang --</option>
								<?php 
                                	foreach($gudang as $g):?>
                                	<option value="<?=$g->id?>"><?=$g->title?></option>
