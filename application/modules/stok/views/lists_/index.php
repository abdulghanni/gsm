        ...
        <div class="col-md-12">
            <div class="row">
				...
				<tr>
					...
					<td>Gudang</td>
					<td>:</td>
					<td><?php echo form_dropdown('gudang_id',$opt_gudang,($this->input->post('gudang_id')?$this->input->post('gudang_id'):''),'class="select2" style="width:100%;"'); ?></td>
				</tr>
					...
					<td>Item</td>
					<td>:</td>
					<td><?php echo form_dropdown('barang_id',$opt_item,($this->input->post('barang_id')?$this->input->post('barang_id'):''),'class="select2" style="width:100%;"'); ?></td>
				</tr>
					<tr>
