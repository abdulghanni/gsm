				...
				<div class="row">
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<!--Bagian Kanan-->
									<?php echo form_dropdown($nm_f,$gudang,(isset($penyesuaian[$nm_f]) ? $penyesuaian[$nm_f] : ''),'class="chosen-select form-control select2" onchange="caristok(this.value)" id="'.$nm_f.'" data-placeholder="Choose a State..." disabled ')?>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<!--Bagian Kanan-->
								<?php echo form_input($nm_f,(isset($penyesuaian[$nm_f]) ? $penyesuaian[$nm_f] : ''),'class="form-control" id="'.$nm_f.'" disabled')?>
                    ...
                    <div class="col-md-5">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<!--Bagian Kanan-->
								<?php echo form_input($nm_f,(isset($penyesuaian[$nm_f]) ? $penyesuaian[$nm_f] : ''),'class="form-control date" id="'.$nm_f.'" disabled')?>
						...
						<table id="table" class="table table-striped">
							<thead>
								...
								<tr>
									...
									<th width="5%"><?php echo $daftar['buku'] ?></th>
									<th width="10%"><?php echo GetValue('title','satuan',array('id'=>'where/'. GetValue('satuan','barang',array('id'=>'where/'.$daftar['kode_barang']))))?> </th>
									...
									<th width="5%"><?php //echo form_dropdown("satuan[$c]",getoptsatuan($daftar['kode_barang']),GetValue('satuan','barang',array('id'=>'where/'.$daftar['kode_barang']))) ?>
										<?php echo form_dropdown("satuan[$c]",GetOptAll('satuan'),GetValue('satuan','barang',array('id'=>'where/'.$daftar['kode_barang'])),'disabled') ?></th>
									<th width="5%"><?php echo $daftar['selisih'] ?></th>
					<th width="5%"><?php //echo form_dropdown("satuan[$c]",getoptsatuan($daftar['kode_barang']),GetValue('satuan','barang',array('id'=>'where/'.$daftar['kode_barang']))) ?>
					<?php echo form_dropdown("satuan[$c]",GetOptAll('satuan'),GetValue('satuan','barang',array('id'=>'where/'.$daftar['kode_barang'])),'disabled') ?></th>
								</tr><?php $c++;}  ?>
							</thead>
