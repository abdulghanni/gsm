				...
				<table id="table" class="table table-striped">
					<thead>
						...
						<th width="10%">Attachment</th>
							...
							$penerimaan_id = getValue('penerimaan_id', 'stok_penerimaan_list', array('id'=>'where/'.$ol->id));
							$no_ref = getValue('no', 'stok_penerimaan', array('id'=>'where/'.$penerimaan_id));
							$penerimaan_date =  getValue('created_on', 'stok_penerimaan', array('id'=>'where/'.$ol->penerimaan_id));
							$penerimaan_date = date('Ymd', strtotime($penerimaan_date));
							?>
							<tr>
