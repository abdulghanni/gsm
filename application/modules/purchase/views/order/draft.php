					...
					<div class="row">
	                    ...
	                    <div class="col-md-6">
	                    	<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="proyek" value="<?=$o->proyek?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="inputPassword3">
								...
								<div class="col-sm-8">
									<input type="text" name="po" value="<?=$o->po?>" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="inputEmail3">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="gudang_id" value="<?=$o->gudang?>" class="form-control" disabled="disabled">
									<input type="hidden" name="gudang_id" value="<?=$o->gudang_id?>" class="form-control">
								</div>
							</div>
							...
							<ul class="list-group">
								...
								<li class="list-group-item">
									<div class="row">
										...
										<div class="col-md-6 pull-right">
										<input type="text" name="diskon_tambahan_nominal" id="diskon-tambahan" class="form-control text-right" value="<?=$o->diskon_tambahan_nominal?>">
										</div>
									</div>
								</li>
								<li class="list-group-item">
