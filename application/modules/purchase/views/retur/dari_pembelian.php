<?php foreach ($order->result() as $o) :?><div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" value="<?=$o->no?>" placeholder="No. Faktur" name="no" class="form-control" required="required">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div id="tanggal_faktur" class="input-append date success no-padding">
                                  <input type="text" class="form-control" name="tanggal_transaksi" value="<?=$o->tanggal_transaksi?>" required>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div id="tanggal_pengiriman" class="input-append date success no-padding">
                                  <input type="text" class="form-control" name="tanggal_pengiriman" value="<?=$o->tanggal_pengiriman?>" required>
                                  <span class="add-on"><span class="arrow"></span><i class="icon-th"></i></span> 
                                </div>
							</div>
						</div>
						...
						<table id="table" class="table table-striped">
							...
							<tbody>
								...
								?>
									...
									<input type="hidden" name="diterima[]" class="form-control text-right" value="<?=$ol->diterima?>">
...
<script type="text/javascript">
	...
	$(".diretur").keyup(function() {
		var a = parseInt($("#diretur<?=$i?>").val());
