		...
		<div class="col-md-12">
			<div class="invoice">
				...
				<div class="row form-row">
					<div class="col-md-6">
						<div class="col-md-4">
							<label class="control-label">Salin Dari No. Faktur</label>
						</div>
						<div class="col-md-8">
							<select class="select2" id="list_pembelian" style="width:100%">
					...
					<div class="row">
	                    ...
	                    <div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" placeholder="No. PO" name="po" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="inputEmail3">
