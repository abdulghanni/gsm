                ...
                <table class="table table-striped table-bordered table-hover table-full-width" id="table">
                    <thead>
                        <tr>
                            ...
                            <th width="30%">Mata Uang Asing</th>
                            <th width="30%">Nilai Dalam Rupiah</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Mata Uang Asing</label>
                            <div class="col-md-9">
                                <input name="mata_uang_asing" placeholder="Mata Uang Asing" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Nilai Dalam Rupiah</label>
                            <div class="col-md-9">
                                <input name="nilai_dalam_rupiah" placeholder="Nilai Dalam Rupiah" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
