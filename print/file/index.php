<?php
	 ...
	 */
	function sti_get_connection_string($connection_type='StiMySqlDatabase', $connection_string)
	{
		switch ($connection_type)
		{
			case "StiSqlDatabase": return "Data Source=SERVER\SQLEXPRESS;Initial Catalog=master;Integrated Security=True";
			case "StiMySqlDatabase": return "Server=localhost;Database=gsm;Port=3306;User=root;Password=;";
		...
		return "Server=localhost;Database=gsm;Port=3306;User=root;Password=;";
